...
|---|---|---|---|---|---|
| Unexpected invoice email with spreadsheet attachment (`Updated invoice 1048` / `billing@vendor.example`) | Email / delivery observable | EVT-001, EVT-008 | User later reported the message as unexpected and stated the attachment was opened. Headers, attachment bytes, and authentication results are not in the dataset. | Suspicious delivery and reported interaction. Not proof the attachment was malicious. | High confidence that EVT-001 and EVT-008 records are present; low confidence that the attachment was malicious |
